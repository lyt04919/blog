    ...
    >
      <div
        ...
        className={cn(
          ...
          "group-data-[orientation=vertical]:w-[2px]",
          ...
          "group-data-[orientation=horizontal]:h-[2px]"
        )}
      />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        orientation === "vertical" && "flex flex-col gap-4 w-full",
        orientation === "horizontal" && "flex flex-row gap-4 h-full",
        className
      )}
    >
      <div
